...
class VI_WOO_LUCKY_WHEEL_Admin_Admin {
	...
	public function admin_enqueue() {
		...
		if ( isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'woo-lucky-wheel' ) {//phpcs:ignore WordPress.Security.NonceVerification.Recommended
			global $wp_scripts;
			...
			wp_enqueue_script( 'woocommerce-lucky-wheel-fontselect-js', VI_WOO_LUCKY_WHEEL_JS . 'jquery.fontselect.min.js', array( 'jquery' ), VI_WOO_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'woocommerce-lucky-wheel-fontselect-css', VI_WOO_LUCKY_WHEEL_CSS . 'fontselect-default.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );

			wp_enqueue_script( 'woocommerce-lucky-wheel-semantic-js-form', VI_WOO_LUCKY_WHEEL_JS . 'form.js', array( 'jquery' ), VI_WOO_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'woocommerce-lucky-wheel-semantic-css-form', VI_WOO_LUCKY_WHEEL_CSS . 'form.min.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );
			wp_enqueue_script( 'woocommerce-lucky-wheel-semantic-js-transition', VI_WOO_LUCKY_WHEEL_JS . 'transition.min.js', array( 'jquery' ), VI_WOO_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'woocommerce-lucky-wheel-semantic-css-transition', VI_WOO_LUCKY_WHEEL_CSS . 'transition.min.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );
			wp_enqueue_script( 'woocommerce-lucky-wheel-semantic-js-dropdown', VI_WOO_LUCKY_WHEEL_JS . 'dropdown.min.js', array( 'jquery' ), VI_WOO_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'woocommerce-lucky-wheel-semantic-css-dropdown', VI_WOO_LUCKY_WHEEL_CSS . 'dropdown.min.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );
			wp_enqueue_script( 'woocommerce-lucky-wheel-semantic-js-checkbox', VI_WOO_LUCKY_WHEEL_JS . 'checkbox.js', array( 'jquery' ), VI_WOO_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'woocommerce-lucky-wheel-semantic-css-checkbox', VI_WOO_LUCKY_WHEEL_CSS . 'checkbox.min.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );
			wp_enqueue_script( 'woocommerce-lucky-wheel-select2-js', VI_WOO_LUCKY_WHEEL_JS . 'select2.js', array( 'jquery' ), VI_WOO_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'woocommerce-lucky-wheel-select2-css', VI_WOO_LUCKY_WHEEL_CSS . 'select2.min.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );
			wp_enqueue_script( 'woocommerce-lucky-wheel-semantic-js-tab', VI_WOO_LUCKY_WHEEL_JS . 'tab.js', array( 'jquery' ), VI_WOO_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_style( 'woocommerce-lucky-wheel-semantic-css-tab', VI_WOO_LUCKY_WHEEL_CSS . 'tab.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );
			wp_enqueue_style( 'woocommerce-lucky-wheel-semantic-css-input', VI_WOO_LUCKY_WHEEL_CSS . 'button.min.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );
			wp_enqueue_style( 'woocommerce-lucky-wheel-semantic-css-table', VI_WOO_LUCKY_WHEEL_CSS . 'table.min.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );
			wp_enqueue_style( 'woocommerce-lucky-wheel-semantic-css-segment', VI_WOO_LUCKY_WHEEL_CSS . 'segment.min.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );
			wp_enqueue_style( 'woocommerce-lucky-wheel-semantic-css-label', VI_WOO_LUCKY_WHEEL_CSS . 'label.min.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );
			wp_enqueue_style( 'woocommerce-lucky-wheel-semantic-css-menu', VI_WOO_LUCKY_WHEEL_CSS . 'menu.min.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );
			wp_enqueue_style( 'woocommerce-lucky-wheel-semantic-css-icon', VI_WOO_LUCKY_WHEEL_CSS . 'icon.min.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );
			...
			wp_enqueue_script( 'woocommerce-lucky-wheel-jquery-address-javascript', VI_WOO_LUCKY_WHEEL_JS . 'jquery.address-1.6.min.js', array( 'jquery' ), VI_WOO_LUCKY_WHEEL_VERSION, true );
			wp_enqueue_script( 'woocommerce-lucky-wheel-admin-javascript', VI_WOO_LUCKY_WHEEL_JS . 'admin-javascript.js', array( 'jquery' ), VI_WOO_LUCKY_WHEEL_VERSION, true );
		...
		wp_enqueue_style( 'woocommerce-lucky-wheel-admin-icon-style', VI_WOO_LUCKY_WHEEL_CSS . 'admin-icon-style.css', array(), VI_WOO_LUCKY_WHEEL_VERSION );
	}
									...
									for ( $i = 1; $i <= 10; $i ++ ) {
										if ( $i == 5 ) {
                                            ...
                                            <option value="<?php echo esc_attr( $i ) ?>"
                                                    selected><?php echo esc_html( $i ); ?></option>
											<?php
										} else {
											?>
                                            <option value="<?php echo esc_attr( $i ) ?>"
                                                    disabled><?php printf( esc_html__( '%s - Premium version only', 'woo-lucky-wheel' ), esc_attr( $i ) );// phpcs:ignore WordPress.WP.I18n.MissingTranslatorsComment ?></option>
											<?php
										}
									}
									?>
